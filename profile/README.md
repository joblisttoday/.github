**joblist.today** is a [curated list of projects and companies hirring around the world](https://github.com/joblisttoday/data) 🌍, and an open system to present, enrich and search that data.
